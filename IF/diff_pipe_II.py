...
class IFDiffImg2ImgSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                current_intermediate_images = self.prepare_intermediate_images(
                    original_image,
                    t,
                    batch_size,
                    num_images_per_prompt,
                ...
                if i == 0:
                    intermediate_images = current_intermediate_images
                else:
                    ...
                    intermediate_images = current_intermediate_images * mask + intermediate_images * (1 - mask)
